...
const val NOT_TO_FULL_LOWER = "не до полного"

// Error Texts
const val EMPTY_FIELD_ERROR = "Поле не может быть пустым!"
const val ODOMETER_LESS_THAN_LAST_ERROR = "Одометр не может быть меньше предыдущего."

// Database
const val DATABASE_NAME = "refueling-db"
